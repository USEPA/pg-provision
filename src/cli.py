...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(prog="pgprov", add_help=False, description="PostgreSQL idempotent provisioner")
    # We don't duplicate the shell flags; we just forward them verbatim.
    parser.add_argument("--help", "-h", action="store_true", help="Show shell script help")
